...
class TaskContoller extends GetxController {
  ...
  void setSelectedItem(Task? item) {
    if (item == null) return;
    final totalUsers = usersList.toList();
    final usersListInt = item.users;
    if (usersListInt != null && usersListInt.isNotEmpty) {
